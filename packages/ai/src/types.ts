...
export interface OpenAICompletionsCompat {
	...
	/** Whether the provider streams raw JSON bodies (not SSE) that must be converted to synthetic SSE. Also gates User-Agent rewriting for WAF-protected proxies. Default: auto-detected from URL. */
	streamsRawJson?: boolean;
}
